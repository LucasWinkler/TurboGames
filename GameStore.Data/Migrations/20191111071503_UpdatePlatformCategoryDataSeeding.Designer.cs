...
namespace GameStore.Data.Migrations
{
    ...
    [Migration("20191111071503_UpdatePlatformCategoryDataSeeding")]
    partial class UpdatePlatformCategoryDataSeeding
    {
            ...
            modelBuilder.Entity("GameStore.Data.User", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "1a1a111-111-11aa-111a-a11aa1a11aa1", AccessFailedCount = 0, ConcurrencyStamp = "231edb2d-8c96-457c-b5e0-81a1164a12a3", DOB = new DateTime(2019, 11, 11, 7, 15, 2, 911, DateTimeKind.Utc), Email = "admin@turbogames.com", EmailConfirmed = true, FirstName = "Turbo", Gender = 2, IsAdmin = true, LastName = "Admin", LockoutEnabled = false, NormalizedEmail = "ADMIN@TURBOGAMES.COM", NormalizedUserName = "ADMIN", PasswordHash = "AQAAAAEAACcQAAAAEMAViK56KENS9pVWIYz7vTU9+I7qifTQOx3Vq+jrcDQwroZqDR64qHv3Wqsk2QC+6A==", PaymentId = new Guid("1c3e6619-7425-40de-944b-e07fc1f90ae7"), PhoneNumberConfirmed = true, SecurityStamp = "1b1b111-111-11bb-111b-b11bb1b11bb1", ShouldReceiveEmails = false, TwoFactorEnabled = false, UserName = "Admin" },
                        new { Id = "2a2a222-222-22aa-222a-a22aa2a22aa2", AccessFailedCount = 0, ConcurrencyStamp = "5632106a-dc5c-41a8-bd51-2ac1ecaf9442", DOB = new DateTime(1999, 6, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), Email = "user@turbogames.com", EmailConfirmed = true, FirstName = "Turbo", Gender = 1, IsAdmin = false, LastName = "User", LockoutEnabled = false, NormalizedEmail = "USER@TURBOGAMES.COM", NormalizedUserName = "USER", PasswordHash = "AQAAAAEAACcQAAAAEP5LG2pvHiEqLdyhrSlaTF42tBwdZFdzCmLxszgO8u1bXiUSU4gsZqFz2zJngFHFsA==", PaymentId = new Guid("1c3e6619-7425-40de-944b-e07fc1f90ae7"), PhoneNumberConfirmed = true, SecurityStamp = "2b2b222-222-22bb-222b-b22bb2b22bb2", ShouldReceiveEmails = false, TwoFactorEnabled = false, UserName = "User" }
                    );
                });
