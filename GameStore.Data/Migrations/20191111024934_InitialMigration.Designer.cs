...
namespace GameStore.Data.Migrations
{
    ...
    [Migration("20191111024934_InitialMigration")]
            ...
            modelBuilder.Entity("GameStore.Data.User", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "1a1a111-111-11aa-111a-a11aa1a11aa1", AccessFailedCount = 0, ConcurrencyStamp = "8a11b8e4-8d51-4bc1-849c-8dfe12ad964a", DOB = new DateTime(2019, 11, 11, 2, 49, 34, 322, DateTimeKind.Utc), Email = "admin@turbogames.com", EmailConfirmed = true, FirstName = "Turbo", Gender = 2, IsAdmin = true, LastName = "Admin", LockoutEnabled = false, NormalizedEmail = "ADMIN@TURBOGAMES.COM", NormalizedUserName = "ADMIN", PasswordHash = "AQAAAAEAACcQAAAAELF5NOM/jsp7Q+s71A8AM9UsbVZppZXW20bibOmFArOPKHHAOaIh89JtXEb+SOf/+Q==", PaymentId = new Guid("1c3e6619-7425-40de-944b-e07fc1f90ae7"), PhoneNumberConfirmed = true, SecurityStamp = "1b1b111-111-11bb-111b-b11bb1b11bb1", ShouldReceiveEmails = false, TwoFactorEnabled = false, UserName = "Admin" },
                        new { Id = "2a2a222-222-22aa-222a-a22aa2a22aa2", AccessFailedCount = 0, ConcurrencyStamp = "26945383-7d44-4e5f-8dd3-5caf4d0df921", DOB = new DateTime(1999, 6, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), Email = "user@turbogames.com", EmailConfirmed = true, FirstName = "Turbo", Gender = 1, IsAdmin = false, LastName = "User", LockoutEnabled = false, NormalizedEmail = "USER@TURBOGAMES.COM", NormalizedUserName = "USER", PasswordHash = "AQAAAAEAACcQAAAAEP6xQitYc6KN1wp6pUvJz2Ku6gzSbrtdrZSO+6iofnWFVHXOV6XwWfj9DK3atsv0xQ==", PaymentId = new Guid("1c3e6619-7425-40de-944b-e07fc1f90ae7"), PhoneNumberConfirmed = true, SecurityStamp = "2b2b222-222-22bb-222b-b22bb2b22bb2", ShouldReceiveEmails = false, TwoFactorEnabled = false, UserName = "User" }
                    );
                });
