...
namespace GameStore.Data.Migrations
{
    ...
    [Migration("20191115032613_UpdateReviewStatus")]
    partial class UpdateReviewStatus
    {
            ...
            modelBuilder.Entity("GameStore.Data.Models.UserGame", b =>
                {
                    ...
                    b.HasData(
                        new { UserId = "2a2a222-222-22aa-222a-a22aa2a22aa2", GameId = new Guid("2c9e6679-7425-40de-944b-e07fc1f90ae7"), PurchaseDate = new DateTime(2019, 11, 15, 3, 26, 13, 338, DateTimeKind.Utc) }
                    );
                });
            ...
            modelBuilder.Entity("GameStore.Data.User", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "2a2a222-222-22aa-222a-a22aa2a22aa2", AccessFailedCount = 0, ConcurrencyStamp = "0d74641e-0906-40aa-b7e2-4e00e5dc67a2", DOB = new DateTime(2019, 11, 15, 3, 26, 13, 335, DateTimeKind.Utc), Email = "user@turbogames.com", EmailConfirmed = true, FirstName = "Turbo", Gender = 2, LastName = "User", LockoutEnabled = false, NormalizedEmail = "USER@TURBOGAMES.COM", NormalizedUserName = "USER", PasswordHash = "AQAAAAEAACcQAAAAEHzA5EZsEyQ3/rhLcqdMHQLeROwxq9h68SgFYSX/ulzcaqxUYMTKMb6K0sNtOfRokw==", PaymentId = new Guid("1c3e6619-7425-40de-944b-e07fc1f90ae7"), SecurityStamp = "42b9e5da-e0a9-420b-9c57-ce1e581bc9c7", ShouldReceiveEmails = false, TwoFactorEnabled = false, UserName = "User" }
                    );
                });
