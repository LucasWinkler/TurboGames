...
namespace GameStore.Data.Migrations
{
    ...
    [Migration("20191111055843_UpdateCreditCardRegex")]
    partial class UpdateCreditCardRegex
    {
            ...
            modelBuilder.Entity("GameStore.Data.User", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "1a1a111-111-11aa-111a-a11aa1a11aa1", AccessFailedCount = 0, ConcurrencyStamp = "a12cdaec-ea66-4bd6-9ce7-dba67c7ce965", DOB = new DateTime(2019, 11, 11, 5, 58, 42, 754, DateTimeKind.Utc), Email = "admin@turbogames.com", EmailConfirmed = true, FirstName = "Turbo", Gender = 2, IsAdmin = true, LastName = "Admin", LockoutEnabled = false, NormalizedEmail = "ADMIN@TURBOGAMES.COM", NormalizedUserName = "ADMIN", PasswordHash = "AQAAAAEAACcQAAAAEHG1HuSUzNQb16bTORqyz5FQwWKvlSgv3oueYgRrrmHj3SCFSyMVwIBbkcPLBJUEwQ==", PaymentId = new Guid("1c3e6619-7425-40de-944b-e07fc1f90ae7"), PhoneNumberConfirmed = true, SecurityStamp = "1b1b111-111-11bb-111b-b11bb1b11bb1", ShouldReceiveEmails = false, TwoFactorEnabled = false, UserName = "Admin" },
                        new { Id = "2a2a222-222-22aa-222a-a22aa2a22aa2", AccessFailedCount = 0, ConcurrencyStamp = "b865abe4-fb32-4e80-aae8-ec707d107271", DOB = new DateTime(1999, 6, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), Email = "user@turbogames.com", EmailConfirmed = true, FirstName = "Turbo", Gender = 1, IsAdmin = false, LastName = "User", LockoutEnabled = false, NormalizedEmail = "USER@TURBOGAMES.COM", NormalizedUserName = "USER", PasswordHash = "AQAAAAEAACcQAAAAEPjT2DDJqnBQGKJSSLAHSO1mM1iOtjHDFHbGCSq4EfLq+jPLY9h5V5NEEXsQWzAZiA==", PaymentId = new Guid("1c3e6619-7425-40de-944b-e07fc1f90ae7"), PhoneNumberConfirmed = true, SecurityStamp = "2b2b222-222-22bb-222b-b22bb2b22bb2", ShouldReceiveEmails = false, TwoFactorEnabled = false, UserName = "User" }
                    );
                });
