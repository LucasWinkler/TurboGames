...
namespace GameStore.Data.Migrations
{
    ...
    [Migration("20191106080545_UpdatePlatformAndCategory")]
    partial class UpdatePlatformAndCategory
    {
            ...
            modelBuilder.Entity("GameStore.Data.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "1a1a111-111-11aa-111a-a11aa1a11aa1", AccessFailedCount = 0, ConcurrencyStamp = "be9db427-d717-48ca-9c54-42f5203ed475", DOB = new DateTime(2019, 11, 6, 8, 5, 44, 719, DateTimeKind.Utc), Email = "admin@gmail.com", EmailConfirmed = true, FirstName = "Turbo", Gender = 2, IsAdmin = true, LastName = "Admin", LockoutEnabled = false, NormalizedEmail = "ADMIN@GMAIL.COM", NormalizedUserName = "ADMIN", PasswordHash = "AQAAAAEAACcQAAAAECZeptm1cSPY/DPTlgIDNsXV+9AI9iRgm6Y9WHqTqv+sZYjLbbccsPtkC/YxrbJ0lg==", PhoneNumberConfirmed = true, SecurityStamp = "1cdcb387-f6bd-4ec3-8cfd-53ef865b496d", TwoFactorEnabled = false, UserName = "Admin" },
                        new { Id = "2a2a222-222-22aa-222a-a22aa2a22aa2", AccessFailedCount = 0, ConcurrencyStamp = "162fe9c1-8346-40bd-a58f-1f5f077d8627", DOB = new DateTime(2019, 11, 6, 8, 5, 44, 721, DateTimeKind.Utc), Email = "standard.user@gmail.com", EmailConfirmed = true, FirstName = "Turbo", Gender = 2, IsAdmin = false, LastName = "User", LockoutEnabled = false, NormalizedEmail = "STANDARD.USER@GMAIL.COM", NormalizedUserName = "USER", PasswordHash = "AQAAAAEAACcQAAAAELkEDwt5DjoneU/znL3ywRM5McWqyFXffClii0sh9TJRdttSOKXaj+2Roh1/4fEVnw==", PhoneNumberConfirmed = true, SecurityStamp = "d4a78888-af07-4d97-88b4-70f0ffe1b177", TwoFactorEnabled = false, UserName = "User" }
                    );
                });
            ...
            modelBuilder.Entity("GameStore.Models.UserGame", b =>
                {
                    ...
                    b.HasData(
                        new { UserId = "1a1a111-111-11aa-111a-a11aa1a11aa1", GameId = new Guid("1c9e6679-7425-40de-944b-e07fc1f90ae7"), PurchaseDate = new DateTime(2019, 11, 6, 8, 5, 44, 721, DateTimeKind.Utc) },
                        new { UserId = "1a1a111-111-11aa-111a-a11aa1a11aa1", GameId = new Guid("3c9e6679-7425-40de-944b-e07fc1f90ae7"), PurchaseDate = new DateTime(2019, 11, 6, 8, 5, 44, 721, DateTimeKind.Utc) },
                        new { UserId = "2a2a222-222-22aa-222a-a22aa2a22aa2", GameId = new Guid("3c9e6679-7425-40de-944b-e07fc1f90ae7"), PurchaseDate = new DateTime(2019, 11, 6, 8, 5, 44, 721, DateTimeKind.Utc) }
                    );
                });
