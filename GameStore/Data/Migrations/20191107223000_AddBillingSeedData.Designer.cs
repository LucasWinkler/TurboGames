...
namespace GameStore.Data.Migrations
{
    ...
    [Migration("20191107223000_AddBillingSeedData")]
    partial class AddBillingSeedData
    {
            ...
            modelBuilder.Entity("GameStore.Data.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "1a1a111-111-11aa-111a-a11aa1a11aa1", AccessFailedCount = 0, AddressId = new Guid("0c3e6619-7425-40de-944b-e07fc1f90ae7"), ConcurrencyStamp = "2f4611ee-f064-4109-9da2-9e44aae318cf", DOB = new DateTime(2019, 11, 7, 22, 30, 0, 445, DateTimeKind.Utc), Email = "admin@gmail.com", EmailConfirmed = true, FirstName = "Turbo", Gender = 2, IsAdmin = true, LastName = "Admin", LockoutEnabled = false, NormalizedEmail = "ADMIN@GMAIL.COM", NormalizedUserName = "ADMIN", PasswordHash = "AQAAAAEAACcQAAAAEJReIqhQaoTIFEab0ru3ruOXRZfJqHkcqMUvUsSCMql5sbCbYgfxlTXH5aBNfDyXFA==", PaymentId = new Guid("1c3e6619-7425-40de-944b-e07fc1f90ae7"), PhoneNumberConfirmed = true, SecurityStamp = "28815b6e-b447-4d8e-924d-6405d879237d", ShouldReceiveEmails = false, TwoFactorEnabled = false, UserName = "Admin" },
                        new { Id = "2a2a222-222-22aa-222a-a22aa2a22aa2", AccessFailedCount = 0, AddressId = new Guid("0c3e6619-7425-40de-944b-e07fc1f90ae7"), ConcurrencyStamp = "cfb5cb4a-5500-42e7-a73f-9ff4cbadf6d3", DOB = new DateTime(2019, 11, 7, 22, 30, 0, 452, DateTimeKind.Utc), Email = "standard.user@gmail.com", EmailConfirmed = true, FirstName = "Turbo", Gender = 2, IsAdmin = false, LastName = "User", LockoutEnabled = false, NormalizedEmail = "STANDARD.USER@GMAIL.COM", NormalizedUserName = "USER", PasswordHash = "AQAAAAEAACcQAAAAEHDjKnjquui/AkPpTMh4l8cZe8ZAaEwM/y5+usXVJnJoLiXKC6RqmX1q837SbYSVlw==", PaymentId = new Guid("1c3e6619-7425-40de-944b-e07fc1f90ae7"), PhoneNumberConfirmed = true, SecurityStamp = "9c003b05-c23b-48dc-8e0d-1f5ea1bda2e7", ShouldReceiveEmails = false, TwoFactorEnabled = false, UserName = "User" }
                    );
                });
