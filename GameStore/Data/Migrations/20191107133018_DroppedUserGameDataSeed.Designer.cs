...
namespace GameStore.Data.Migrations
{
    ...
    [Migration("20191107133018_DroppedUserGameDataSeed")]
    partial class DroppedUserGameDataSeed
    {
            ...
            modelBuilder.Entity("GameStore.Data.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "1a1a111-111-11aa-111a-a11aa1a11aa1", AccessFailedCount = 0, ConcurrencyStamp = "a9bfed2c-b558-436c-899a-a2bf99a0a182", DOB = new DateTime(2019, 11, 7, 13, 30, 18, 171, DateTimeKind.Utc), Email = "admin@gmail.com", EmailConfirmed = true, FirstName = "Turbo", Gender = 2, IsAdmin = true, LastName = "Admin", LockoutEnabled = false, NormalizedEmail = "ADMIN@GMAIL.COM", NormalizedUserName = "ADMIN", PasswordHash = "AQAAAAEAACcQAAAAEEEtqz7ZX70f5P5RYgemvoEEUbfp38flQ4PreF0azD8Qyx02YlRxcqFHjfpzukXq/g==", PhoneNumberConfirmed = true, SecurityStamp = "20b1e1db-5902-40e1-870c-4deaf5a30806", ShouldReceiveEmails = false, TwoFactorEnabled = false, UserName = "Admin" },
                        new { Id = "2a2a222-222-22aa-222a-a22aa2a22aa2", AccessFailedCount = 0, ConcurrencyStamp = "66233a57-55c1-4139-962c-9bdb1bac14b4", DOB = new DateTime(2019, 11, 7, 13, 30, 18, 172, DateTimeKind.Utc), Email = "standard.user@gmail.com", EmailConfirmed = true, FirstName = "Turbo", Gender = 2, IsAdmin = false, LastName = "User", LockoutEnabled = false, NormalizedEmail = "STANDARD.USER@GMAIL.COM", NormalizedUserName = "USER", PasswordHash = "AQAAAAEAACcQAAAAEFWeb3fVTgT0BJASwFeUyzZwu+Mppuy05LPzT96aF6OKe0hYPoIQ0zPsHdPrTVGV/A==", PhoneNumberConfirmed = true, SecurityStamp = "242acaee-9263-4d78-b3f2-5630ff5a8923", ShouldReceiveEmails = false, TwoFactorEnabled = false, UserName = "User" }
                    );
                });
