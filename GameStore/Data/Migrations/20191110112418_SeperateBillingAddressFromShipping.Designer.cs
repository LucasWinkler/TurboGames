...
namespace GameStore.Data.Migrations
{
    ...
    [Migration("20191110112418_SeperateBillingAddressFromShipping")]
    partial class SeperateBillingAddressFromShipping
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameStore.Data.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "1a1a111-111-11aa-111a-a11aa1a11aa1", AccessFailedCount = 0, BillingAddressId = new Guid("0c3e6619-7425-40de-944b-e07fc1f90ae7"), ConcurrencyStamp = "da09b743-1566-444e-8089-63ee7a95f0d0", DOB = new DateTime(2019, 11, 10, 11, 24, 18, 382, DateTimeKind.Utc), Email = "admin@gmail.com", EmailConfirmed = true, FirstName = "Turbo", Gender = 2, IsAdmin = true, LastName = "Admin", LockoutEnabled = false, NormalizedEmail = "ADMIN@GMAIL.COM", NormalizedUserName = "ADMIN", PasswordHash = "AQAAAAEAACcQAAAAENKymkkxOl0U53jptnFGUQxLR53XfBb82Xt8vKO55jFQlDYf26PdBo1WOv8RUVnQOw==", PaymentId = new Guid("1c3e6619-7425-40de-944b-e07fc1f90ae7"), PhoneNumberConfirmed = true, SecurityStamp = "e88aff1a-6f27-49a4-91c6-c0d2942f14d6", ShippingAddressId = new Guid("0c3e6619-7425-40de-944b-e07fc1f90ae7"), ShouldReceiveEmails = false, TwoFactorEnabled = false, UserName = "Admin" },
                        new { Id = "2a2a222-222-22aa-222a-a22aa2a22aa2", AccessFailedCount = 0, BillingAddressId = new Guid("0c3e6619-7425-40de-944b-e07fc1f90ae7"), ConcurrencyStamp = "857c906d-371f-4aab-a3b8-066c90ca032c", DOB = new DateTime(2019, 11, 10, 11, 24, 18, 385, DateTimeKind.Utc), Email = "standard.user@gmail.com", EmailConfirmed = true, FirstName = "Turbo", Gender = 2, IsAdmin = false, LastName = "User", LockoutEnabled = false, NormalizedEmail = "STANDARD.USER@GMAIL.COM", NormalizedUserName = "USER", PasswordHash = "AQAAAAEAACcQAAAAEHqaLXyMgI6aUinUG7ij1bjI+6Mb0pNI+PHzD1fGxgpRntMj7cUCznInF2jsvvvDKw==", PaymentId = new Guid("1c3e6619-7425-40de-944b-e07fc1f90ae7"), PhoneNumberConfirmed = true, SecurityStamp = "b57b9994-8f7c-4d27-9973-26467482c12d", ShippingAddressId = new Guid("0c3e6619-7425-40de-944b-e07fc1f90ae7"), ShouldReceiveEmails = false, TwoFactorEnabled = false, UserName = "User" }
                    );
                });
            ...
            modelBuilder.Entity("GameStore.Models.Address", b =>
                {
                    ...
                    b.HasData(
                        new { Id = new Guid("0c3e6619-7425-40de-944b-e07fc1f90ae7"), City = "Cambridge", Country = "Canada", PostalCode = "N1P1H1", PrimaryAddress = "57 Kingsboro Road", Province = "Ontario" }
                    );
                });
            ...
            modelBuilder.Entity("GameStore.Data.ApplicationUser", b =>
                {
                    b.HasOne("GameStore.Models.Address", "BillingAddress")
                        .WithMany()
                    ...
                    b.HasOne("GameStore.Models.Address", "ShippingAddress")
                        .WithMany()
