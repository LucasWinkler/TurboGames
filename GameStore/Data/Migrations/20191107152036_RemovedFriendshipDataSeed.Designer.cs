...
namespace GameStore.Data.Migrations
{
    ...
    [Migration("20191107152036_RemovedFriendshipDataSeed")]
    partial class RemovedFriendshipDataSeed
    {
            ...
            modelBuilder.Entity("GameStore.Data.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "1a1a111-111-11aa-111a-a11aa1a11aa1", AccessFailedCount = 0, ConcurrencyStamp = "74d2c27e-952d-407c-b575-891591a86ee7", DOB = new DateTime(2019, 11, 7, 15, 20, 36, 4, DateTimeKind.Utc), Email = "admin@gmail.com", EmailConfirmed = true, FirstName = "Turbo", Gender = 2, IsAdmin = true, LastName = "Admin", LockoutEnabled = false, NormalizedEmail = "ADMIN@GMAIL.COM", NormalizedUserName = "ADMIN", PasswordHash = "AQAAAAEAACcQAAAAEHc3Mlpuw4Uixfwdm1LHaAso7x+cZjJ4A/N8Z/W5MKj9juhXDdQwlMoCtEG4jxJOsw==", PhoneNumberConfirmed = true, SecurityStamp = "9b5e774e-41dd-42df-914a-4ebd288fdeac", ShouldReceiveEmails = false, TwoFactorEnabled = false, UserName = "Admin" },
                        new { Id = "2a2a222-222-22aa-222a-a22aa2a22aa2", AccessFailedCount = 0, ConcurrencyStamp = "027fbc97-a874-401d-8cd7-82472ae1ae06", DOB = new DateTime(2019, 11, 7, 15, 20, 36, 6, DateTimeKind.Utc), Email = "standard.user@gmail.com", EmailConfirmed = true, FirstName = "Turbo", Gender = 2, IsAdmin = false, LastName = "User", LockoutEnabled = false, NormalizedEmail = "STANDARD.USER@GMAIL.COM", NormalizedUserName = "USER", PasswordHash = "AQAAAAEAACcQAAAAEKTb6qzt3saJY1A8LVGkVp5OptXSp7KXVdeWlHb0xk/RKWmghMZPG7op57WummFSiQ==", PhoneNumberConfirmed = true, SecurityStamp = "756d769a-51e0-4421-a715-9cd775446575", ShouldReceiveEmails = false, TwoFactorEnabled = false, UserName = "User" }
                    );
                });
